...
<article>
        ...
        <?php while($question = mysql_fetch_row($result1)): ?>
          <?php foreach ($question as $key => $value): ?>
            ...
            <?php while($choice = mysql_fetch_row($result2)) : ?>
                ...
                <input type="radio" name ="<?php echo $choice[0];?>" value = "<?php echo $choice[1];?>">
                <?php echo $choice[0]; ?>
                </label>
        ...
        <?php endforeach; ?>
        <?php endwhile; ?>
        <input type = "submit" value = "Complete!" class = "btn btn-lg btn-success" onClick="window.location.href='survey.php'">
        </div>
        </form>
</article>
</body>
